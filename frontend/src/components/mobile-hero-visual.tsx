...
export function MobileHeroVisual() {
  ...
  return (
    <div className="relative w-full rounded-2xl border border-white/10 bg-background/80 backdrop-blur-md overflow-hidden">
      <div className="flex items-center gap-2 px-3 py-2 border-b border-white/10">
        <span className="w-2.5 h-2.5 rounded-full bg-red-500" />
        <span className="w-2.5 h-2.5 rounded-full bg-amber-500" />
        <span className="w-2.5 h-2.5 rounded-full bg-emerald-500" />
        <span className="ml-2 text-[10px] font-mono text-muted-foreground">~/portfolio — zsh</span>
      </div>
